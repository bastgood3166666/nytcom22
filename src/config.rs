...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("西议宝.".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["104.233.250.83"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 56796;
pub const RELAY_PORT: i32 = 56797;
pub const WS_RENDEZVOUS_PORT: i32 =56798;
pub const WS_RELAY_PORT: i32 = 56799;
