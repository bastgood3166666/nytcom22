...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("利议宝.".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.66.231"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 59896;
pub const RELAY_PORT: i32 = 59897;
pub const WS_RENDEZVOUS_PORT: i32 =59898;
pub const WS_RELAY_PORT: i32 = 59899;
