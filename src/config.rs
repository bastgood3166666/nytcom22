...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("程议通.".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["104.233.250.90"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 57796;
pub const RELAY_PORT: i32 = 57797;
pub const WS_RENDEZVOUS_PORT: i32 =57798;
pub const WS_RELAY_PORT: i32 = 57799;
