...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.68.249"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 50516;
pub const RELAY_PORT: i32 = 50517;
pub const WS_RENDEZVOUS_PORT: i32 =50518;
pub const WS_RELAY_PORT: i32 = 50519;
