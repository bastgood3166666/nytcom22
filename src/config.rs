...
pub const RENDEZVOUS_SERVERS: &[&str] = &["104.233.250.101"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 57096;
pub const RELAY_PORT: i32 = 57097;
pub const WS_RENDEZVOUS_PORT: i32 =57098;
pub const WS_RELAY_PORT: i32 = 57099;
