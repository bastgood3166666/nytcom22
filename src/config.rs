...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.66.36"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 59096;
pub const RELAY_PORT: i32 = 59097;
pub const WS_RENDEZVOUS_PORT: i32 =59098;
pub const WS_RELAY_PORT: i32 = 59099;
