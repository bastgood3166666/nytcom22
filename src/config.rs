...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.68.148"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 59696;
pub const RELAY_PORT: i32 = 59697;
pub const WS_RENDEZVOUS_PORT: i32 =59698;
pub const WS_RELAY_PORT: i32 = 59699;
