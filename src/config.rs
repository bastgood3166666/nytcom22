...
pub const RENDEZVOUS_SERVERS: &[&str] = &["104.233.250.99"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 56996;
pub const RELAY_PORT: i32 = 56997;
pub const WS_RENDEZVOUS_PORT: i32 =56998;
pub const WS_RELAY_PORT: i32 = 56999;
