...
pub const RENDEZVOUS_SERVERS: &[&str] = &["104.233.250.82"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 56596;
pub const RELAY_PORT: i32 = 56597;
pub const WS_RENDEZVOUS_PORT: i32 =56598;
pub const WS_RELAY_PORT: i32 = 56599;
