...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.68.105"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 58996;
pub const RELAY_PORT: i32 = 58997;
pub const WS_RENDEZVOUS_PORT: i32 =58998;
pub const WS_RELAY_PORT: i32 = 58999;
