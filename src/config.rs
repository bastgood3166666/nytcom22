...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.68.216"];
pub const RS_PUB_KEY: &str = "39iCJusN1Mh+H7OqXB8i10yeRlfG2ytJbtBN5y3CQhM=";
pub const RENDEZVOUS_PORT: i32 = 29956;
pub const RELAY_PORT: i32 = 29957;
pub const WS_RENDEZVOUS_PORT: i32 =29958;
pub const WS_RELAY_PORT: i32 = 29959;
