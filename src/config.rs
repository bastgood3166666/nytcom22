...
pub const RENDEZVOUS_SERVERS: &[&str] = &["104.233.250.84"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 56696;
pub const RELAY_PORT: i32 = 56697;
pub const WS_RENDEZVOUS_PORT: i32 =56698;
pub const WS_RELAY_PORT: i32 = 56699;
